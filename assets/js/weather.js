// --------------------------------------------------------------local weather----------------------------------------------------------
$.getJSON(
  "https://api.openweathermap.org/data/2.5/weather?q=ireland&units=metric&APPID=2a1b20e296836689a2296c960cf5a29a",
  function (data) {
    let icon =
...
// -----------prepopulate weatherdata
function prePopWeather(countryname) {
  $.getJSON(
    "https://api.openweathermap.org/data/2.5/weather?q=" +
      countryname +
      "&units=metric&APPID=2a1b20e296836689a2296c960cf5a29a",
    function (citydata) {
      ...
      document.getElementById("wind2").innerHTML = `Wind Speed: ${Math.round(
        citydata.wind.speed
      )} KPH`;
      document.getElementById("direction2").innerHTML = windDirection;
      document.getElementById(
        "humidity2"
      ).innerHTML = `${citydata.main.humidity} degrees humidity`;

      if (windDirection >= 270) {
        document.getElementById("direction2").innerHTML =
          "Wind Direction: Northerly"; // added this code to show wind as a direction
